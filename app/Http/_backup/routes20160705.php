...
Route::group(array('prefix' => '/dnradmin'), function()
 { 
   ...
   Route::get('/graphik/display_all/{type}', 'GraphikDimensionController@displayAll');
    Route::get('/graphik/display_price', 'GraphikDimensionController@getPricing');        
 });	
...
define('EmailFrom','angela@tekcopia.com');
define('EmailFromName','Clarkin');
define('EmailTo','boyet@dogandrooster.com');
define('EmailToName','John Doe');
