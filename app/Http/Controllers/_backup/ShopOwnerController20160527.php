...
class ShopOwnerController extends Controller
{
    ...
    {   
        ...
        return View::make('_admin.shop_owner.shop_owner', array('shopOwner' => $shopOwner,'administrator'=>$administrator,'shopClass'=>$shopClass));
    }
   ...
   public function getEdit($id) {
	   ...
	   $manager = Manager::orderBy('fldManagerFirstname')
	    ...
	    return View::make('_admin.shop_owner.shop_owner_edit', array('shopOwner' => $shopOwner,'administrator'=>$administrator,'shopClass'=>$shopClass,'manager'=>$manager));		
   }
	...
	public function login(Request $requestShopOwner) {
		...
		if ($validator->fails()) {    		
			...
			//Session::flash('error',"Invalid username or password."); 		
			 $requestShopOwner->session()->put('shop_owner_id', $shopOwner->fldShopOwnerID);	
	...
	public function newRegistration() {
	    ...
	    if ($validator->fails()) {    			
		  ...
		  $promocode = strtoupper('SO'.Str::random(4));
		   ...
		   Session::flash('success',"You has been successfully registered."); 		   
