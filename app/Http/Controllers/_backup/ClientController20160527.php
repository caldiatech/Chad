...
class ClientController extends Controller
{
   ...
   public function postEdit($id) {	  
	...
	public function profileEdit() {
		...
		return View::make('dashboard.customer.edit-profile', compact('client_id','client','pages','settings','birthDate','shipping','braintreeClient','braintreeMerchant') );
	}	
