	...
	*/
	...
	public function details($slug) {
		...
		list($frameDesc,$frameWidth,$sku,$graphikAPI,$colorValue, $styleValue,$widthValue,$materialValue,$framePrice) = GraphikDimension::getGraphikAttribute($graphikAPI->frame);
	        ...
	        //$price = GraphikDimension::getFramePricing($product->fldProductImage, url(PRODUCT_IMAGE_PATH.$product->fldProductSlug.'/'.$product->fldProductImage),0,0,0,$sku,0,0,0,0,0,0,0,0);
		//print_r($price);die();
