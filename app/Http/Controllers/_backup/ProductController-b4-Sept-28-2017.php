	...
	*/
	...
	public function details($slug) {
		...
		*/
		...
		// View::make('home.products-details', compact('menus','category','category_details','product','productImage','google','cart_count','settings','footer','graphikAPI','color','styleValue','widthValue','sku','frameWidth','framePrice','frameDesc','slideFinalCount','graphikPaperAPI','graphikCanvassAPI','graphikMatsAPI','graphikGlazingAPI','productOption','packagePrice'));
	}
