...
class ProductController extends Controller
{
	...
	*/
	...
	public function getGraphikPapersAPI(){
		$GraphikPapersAPI = \App\Models\GraphikDimension::displayAll(4); //for mats
		/*$default_paper = array();
	...
	public function getGraphikFramesAPI(){
		$graphikAPI = \App\Models\GraphikDimension::displayAll(1); //for mats
		/*$default_paper = array();
		foreach($GraphikPapersAPI->paper as $GraphikPapersAPIs){
		...
		return array('frameDesc'=>$frameDesc,'frameWidth'=>$frameWidth,'sku'=>$sku,'graphikAPI'=>$graphikAPI,'colorValue'=>$colorValue, 'styleValue'=>$styleValue,'widthValue'=>$widthValue,'materialValue'=>$materialValue,'framePrice'=>$framePrice,'graphikAPIFrame'=>$graphikAPI->frame);
