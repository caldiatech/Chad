...
class PagesController extends Controller
{
    ...
    public function getSlug($slug)
    {
        ...
        return View::make('home.pages', ['page' => $pages]);
    }
    ...
    public function home()
    {
        ...
        /* get prices */
        $product_array_id = $product_array_prices = $product_array_highest_prices = $product_array_lowest_prices = [];
        ...
        //dd($product);
        return View::make('home.index')->with(['menus' => $menus,
            'homeslide'                                         => $homeslide,
...
// die();
        ...
        if (empty($pages)) {
            ...
            return View::make('errors.404')->with(['pages' => $pages,
                'menus'                                             => $menus,
                'settings'                                          => $settings,
                'google'                                            => $google,
                'cart_count'                                        => $cart_count,
            ...
            return View::make('home.about')->with(['pages' => $pages,
                'menus'                                             => $menus,
                'settings'                                          => $settings,
                'google'                                            => $google,
                'cart_count'                                        => $cart_count,
            ...
            if (! empty($pages->fldPagesFilename)) {
                return View::make('home.' . $pages->fldPagesFilename)->with(['pages' => $pages,
                    'menus'                                                                   => $menus,
                    'settings'                                                                => $settings,
                    'google'                                                                  => $google,
                    'cart_count'                                                              => $cart_count,
                ...
                return View::make('home.pagesnew')->with(['pages' => $pages,
                    'menus'                                                => $menus,
                    'settings'                                             => $settings,
                    'google'                                               => $google,
                    'cart_count'                                           => $cart_count,
    ...
    public function store($slug = 'store')
    {
        ...
        $cart_count   = TempCart::countCart();
        $footer       = Footer::first();
        return View::make('home.store')->with(['pages' => $pages,
            'menus'                                             => $menus,
            'settings'                                          => $settings,
            'google'                                            => $google,
            'cart_count'                                        => $cart_count,
    ...
    public function dashboard($category = 'customer', $slug = "index")
    {
        ...
        if (View::exists('dashboard.' . $category . '.' . $slug)) {
            return View::make('dashboard.' . $category . '.' . $slug)->with(['pages' => $pages,
                'menus'                                                                       => $menus,
                'settings'                                                                    => $settings,
                'google'                                                                      => $google,
                'cart_count'                                                                  => $cart_count,
            ...
            return View::make('dashboard.' . $category . '.index')->with(['pages' => $pages,
                'menus'                                                                    => $menus,
                'settings'                                                                 => $settings,
                'google'                                                                   => $google,
                'cart_count'                                                               => $cart_count,
    ...
    public function thankyouDisplay($slug, $merchant)
    {
        ...
        return View::make('home.thankyou')->with(['pages' => $pages, 'menus' => $menus, 'category' => $category, 'settings' => $settings, 'cart_count' => $cart_count]);
    }
    ...
    public function thankyouContact($slug)
    {
        ...
        return View::make('home.thankyou')->with(['pages' => $pages,
            'menus'                                                => $menus,
            'settings'                                             => $settings,
            'google'                                               => $google,
            'footer'                                               => $footer,
    ...
    public function login()
    {
        ...
        return View::make('home.login')->with(['pages' => $pages,
            'menus'                                             => $menus,
            'category'                                          => $category,
            'settings'                                          => $settings,
            'google'                                            => $google,
    ...
    public function registration()
    {
        ...
        $cart_count          = TempCart::countCart();
        return View::make('home.registration')->with(['menus' => $menus,
            'category'                                                 => $category,
            'settings'                                                 => $settings,
            'google'                                                   => $google,
            'pages'                                                    => $pages,
    ...
    public function forgot_password()
    {
        ...
        $cart_count          = TempCart::countCart();
        $pages               = Pages::find(45);
        return View::make('home.forgot-password')->with(['menus' => $menus,
            'category'                                                    => $category,
            'settings'                                                    => $settings,
            'google'                                                      => $google,
            'pages'                                                       => $pages,
    ...
    public function salesRegistration()
    {
        ...
        $settings->site_name = "Registration";
        $cart_count          = TempCart::countCart();
        return View::make('home.registration_sales')->with(['menus' => $menus,
            'category'                                                       => $category,
            'settings'                                                       => $settings,
            'google'                                                         => $google,
            'pages'                                                          => $pages,
    ...
    public function salesLogin()
    {
        ...
        return View::make('home.sales_login')->with(['pages' => $pages, 'menus' => $menus,
            'category'                                                => $category,
            'settings'                                                => $settings,
            'google'                                                  => $google,
            'cart_count'                                              => $cart_count]);
    ...
    public function shopLogin()
    {
        ...
        return View::make('home.shop_owner_login')->with(['pages' => $pages, 'menus' => $menus,
            'category'                                                     => $category,
            'settings'                                                     => $settings,
            'google'                                                       => $google,
            'cart_count'                                                   => $cart_count]);
    ...
    public function shopRegistration()
    {
        ...
        $settings->site_name = "Registration";
        $cart_count          = TempCart::countCart();
        return View::make('home.registration_shop_owner')->with(['menus' => $menus,
            'category'                                                            => $category,
            'settings'                                                            => $settings,
            'google'                                                              => $google,
            'pages'                                                               => $pages,
	...
	*/
    ...
    public function FAQContact()
    {
        ...
        if ($validator->fails()) {
            ...
            $contacts = ["questions" => $question, "email" => $email];
