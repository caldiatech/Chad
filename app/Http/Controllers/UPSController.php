  ...
  public function getIndex()
    {
		...
		$pageTitle = SHIPPING_UPS;
        return View::make('_admin.shipping.shipping_ups', array('shipping' => $shipping,'administrator'=>$administrator,'shippingClass'=>$shippingClass,'pageTitle'=>$pageTitle));
    }
