...
class SalesRepController extends Controller
{
    ...
    {   
		...
		$pageTitle = SALESREP_MANAGEMENT;
	        return View::make('_admin.sales_rep.index', array('manager' => $manager,'administrator'=>$administrator,'salesClass'=>$salesClass,'pageTitle'=>$pageTitle));
    }
    ...
    public function getSales($manager_id) {
		...
		$salesClass = 'class=active';
		$pageTitle = SALESREP_MANAGEMENT;
		return View::make('_admin.sales_rep.sales', compact('manager','administrator','salesClass','cart','pageTitle'));	 
	}
   ...
   public function getEdit($id) {
	   ...
	   $salesClass = 'class=active';
	    ...
	    $pageTitle = SALESREP_MANAGEMENT;	
	    return View::make('_admin.sales_rep.edit', array('manager' => $manager,'administrator'=>$administrator,'salesClass'=>$salesClass,'braintreeClient'=>$braintreeClient,'braintreeMerchant'=>$braintreeMerchant,'pageTitle'=>$pageTitle));		
   }
