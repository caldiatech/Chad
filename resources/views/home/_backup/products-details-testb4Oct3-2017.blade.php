...
var frames_array = new Array(), frame_materials = new Array();
...
*/
      ...
      function generateSldieshow(){
        ...
        var vargetFrameWidthSelectionValuesVV = new Array();
        if(filter_array_values['frameWidth'] != undefined){          
          var vargetFrameWidthSelectionValuesVV = getFrameWidthSelectionValuesVV(filter_array_values['frameWidth']);         
        }

        var slideshow_html_array = new Array();
        var frame_ss_page = 0, frame_ss_column = 0, slideshowhtml = '', include_me = false; 
         ...
         $.each(frames_array, function(obj_index, obj_value ){            
            ...
            if(vargetFrameWidthSelectionValuesVV[0] != undefined && vargetFrameWidthSelectionValuesVV[1] != undefined ){
              if(obj_value.frameWidthValue >= vargetFrameWidthSelectionValuesVV[0] && obj_value.frameWidthValue <= vargetFrameWidthSelectionValuesVV[1]){
                include_me = true;
              }
            }
