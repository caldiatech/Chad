...
var ffilter_array = new Array();
    ...
    $(document).ready(function(){
      ...
      function set_frame_slider_h(){
        var get_image_h = $('#frame_slider .frame-slider-subitem').height();
        var get_frameslider_h = $('#frame_slider .uk-slideshow').height();
        if(get_frameslider_h < get_image_h){
          $('#frame_slider .uk-slideshow').css('height',get_image_h+'px');
        }
      }
