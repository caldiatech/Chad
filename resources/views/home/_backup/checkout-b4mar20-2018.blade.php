        ...
        {!! Form::open(array('url' => '/checkout', 'method' => 'post',  'class' => 'row-fluid full-width uk-margin-large-top input-100 bill-info uk-form','id'=>'page_form')) !!}
            ...
            <div class="uk-grid">
                ...
                <?php 
                    ...
                    $tax_total = $discount_total * ($tax/100); 
                    $grand_total = $discount_total + $tax_total;
                ?>
                    ...
                    <div class="order-total box-bordered padding-medium  uk-text-left">
                        ...
                        <table class="uk-table uk-table-small">
                            ...
                            <tr class="border-top">
                                ...
                                <td class="uk-text-right roboto"><strong>$<span id="subtotal">@if(empty($cart[0]->subtotal)) <?php  $cart[0]->subtotal=$sub_total=0; ?> @endif {!! number_format($cart[0]->subtotal,2) !!}</span> @if(empty($coupon_code)) <?php settype($coupon_code,'object'); ?> @endif  </strong>
                            ...
                            <tr class="border-top">
                                ...
                                <td class="uk-text-right roboto"><strong><span id="taxvaluedisplay">{!!number_format(check_numeric($tax_total),2)!!}</span></strong></td>
                            </tr>
                            ...
                            @endif
                             <tr class="border-top">
                                ...
                                {!! Form::hidden('grand_total',$grand_total,array('id'=>'grand_total')) !!}
...
<script language="javascript">
    ...
    tax_amount = 0, tax_total = 0, sub_total = 0, total_temp = 0, shipping_amount = grand_total = discount_amount = discounted_total = 0;
        ...
        function checkTax(state) {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    console.log(tax_amount);
                    tax_total = discounted_total * (tax_amount/100);
