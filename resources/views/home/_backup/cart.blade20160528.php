 ...
 <div class="uk-width-1-1 uk-margin-large  uk-margin-large-top"> 
    ...
    <div class="uk-width-1-1"> 
        ...
        @if (session()->has('message')) 
            <div id="" style="margin-bottom:10px;" class="uk-alert uk-text-center uk-text-large uk-alert-success"><i class="uk-icon uk-icon-check-circle"></i> <strong>Success:</strong> The quantity of your shopping cart have been updated.</div>
        @endif                
        ...
        <table class="uk-table cart-order-list">
            ...
            <tfoot>
                <tr class="border-top border-bottom">
                    <td colspan="3"> 
                    <div id="coupon_error" style="display:none; margin-bottom:10px; max-width: 288px;" class="uk-alert uk-alert-danger uk-alert-error">Invalid Coupon code</div>
                    <div id="coupon_error_success" style="display:none; margin-bottom:10px;  max-width: 288px;" class="uk-alert uk-alert-success"><strong>Success!</strong> Coupon code is valid!</div>
