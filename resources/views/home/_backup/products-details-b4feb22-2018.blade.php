...
<div class="uk-container uk-container-center uk-margin-medium-bottom  uk-padding-remove product-detail-wrapper  product-type-{{$fldProductIsVertical}}">
  <article id="main" role="main">
    ...
    <div class="product-column-wrapper uk-position-relative">
        ...
        <div class="frame-box-container">
            <div class="frame-style-box frame-706x639">
                 <a href="#enlargedImage" class="uk-overlay" data-uk-modal>
                  {!! Html::image(url(PRODUCT_IMAGE_PATH.$product->fldProductSlug.'/'.$product->fldProductImage),'',array('class'=>'frame-style w100 hauto mauto','width'=>'706','height'=>'639', 'id'=>'mainImage', 'data-sku' => 'SA9','data-width' => 1.5, 'data-desc' =>"SA9 Black Black Satin" )) !!}
      ...
      <div class="uk-width-1-1 uk-width-small-6-10 product-details-column">
...
var ffilter_array = new Array(), recursive_img_render;
var doit;
    ...
    $(document).ready(function(){
      ...
      function loadFrameSlider(frame_ss_page){
            ...
            var load_img_src = $('#frame_slider .frame-slider-subitem img#frameimg-0').attr('src');
            $('#frame_slider .frame-slider-subitem img#frameimg-0').attr('src', load_img_src).load(function() {  
               set_frame_slider_h();  
            });
...
window.sortMeBy = (function(){
  ...
  function generateNewImageFrame() {
    ...
    $("#frame_width").val($("#mainImage").attr('data-width'));
