    <div class="uk-grid">
          <div class="uk-width-large-1-1 uk-margin-top uk-margin-large-bottom">  
                @if($client->fldClientBraintreeCustomerID != "") 
                    {!! Form::checkbox('braintree',1,0,['id'=>'braintree']) !!} <span class="uk-text-danger"><strong>Pay via Braintree</strong></span>
                @endif    
          </div>  
    </div>
    ...
    <div id="ccInformation">
                    <div class="control-group"  style="">
                        ...
                        <div class="uk-grid controls">
                            ...
                            {!! Form::text('card_firstname','',array('pattern'=>'\w+.*','required','placeholder'=>'First name','title'=>'Fill your First name','class'=>'form-control','id'=>'card_firstname')) !!}
                            </div>
                            <div class="uk-width-large-1-2 uk-width-medium-1-3 uk-width-small-1-2 uk-margin-top">
                            {!! Form::text('card_lastname','',array('pattern'=>'\w+.*','required','placeholder'=>'Last name','title'=>'Fill your Last name', 'class'=>'form-control','id'=>'card_lastname')) !!}                        
                           </div>
                        </div>
                    </div><!--control-group -->
                    <div class="control-group uk-margin-top">	
                        <label class="control-label">Card Number (4111 1111 1111 1111)</label>
                        <div class="controls">
                            <div class="uk-grid">
                                ...
                                <div class="uk-width-large-1-4 uk-width-medium-1-2 uk-width-small-1-2 uk-margin-top">
                                    {!! Form::text('card_no4','',array('id'=>'card_no4','pattern'=>'\d{4}','required','class'=>'form-control','title'=>'Fourth four digits','rel'=>'1','autocomplete'=>'off','maxlength'=>'4','id'=>'card_no4')) !!}
