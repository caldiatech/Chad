  ...
  <article id="main" role="main">
    ...
    <div class="product-column-wrapper uk-position-relative">
      ...
      <div class="uk-width-1-1 uk-width-medium-6-10 product-details-column">
                      ...
                      <div class="uk-width-large-1-2 add-to-cart-section uk-width-1-1">
                       <div class="uk-form-row">
                            <div class="uk-grid uk-form-horizontal uk-text-right uk-margin-remove " id="add-to-cart">
                              <div class="uk-width-large-5-10 uk-width-medium-4-10 uk-width-small-1-2 uk-width-1-1 uk-padding-remove cart-number-picker">
            ...
            <ul class="uk-subnav product-tab-components uk-tab uk-subnav-pill" data-uk-switcher="{connect:'#product-detail-switcher', animation: 'fade',active:0}">
...
.frame-style-box.rendering-img > a {
    opacity: 0.7;
}
.frame-style-box.rendering-img:before {
    content: 'Loading..';
    position: absolute;
    top: -50%;
    margin: auto;
    ...
    z-index: 11111;
    height: 20px;
    font-size: 20px;    text-shadow: 0px 0px 4px #ffffff;
    font-weight: 600;
}
      ...
      */
      ...
      $.ajax({
        ...
        success: function(data){
            ...
            var this_data = JSON.parse(data);
            console.log("{{url('product-api')}}/frames"+'this_data');
...
window.sortMeBy = (function(){
  ...
  function generateNewImageFrame() {
    ...
    var newSrc = "https://pod.cloud.graphikservices.com/renderEMF/render?imgUrl={{ url(PRODUCT_IMAGE_PATH.$product->fldProductSlug.'/'.MEDIUM_IMAGE.$product->fldProductImage) }}&imgHI="+imageHeight+"&imgWI="+imageWidth+"&maxW=400&maxH=400&m1b=1&off=0.375&sku="+$("#mainImage").attr('data-sku')+"&frameW="+$("#mainImage").attr('data-width');
