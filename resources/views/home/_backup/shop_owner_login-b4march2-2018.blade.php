        ...
        <div class="uk-grid">
          <div class="uk-width-medium-2-3 uk-width-small-1-1">
            <div class="uk-container">
                <h4 class="uk-text-contrast">Registered Shop Owner</h4>
                ...
                @endif
                 {!! Form::open(array('url' => '/shop-owner-login', 'method' => 'post',  'class' => 'row-fluid account-login input-100')) !!}
                <div class="formbox">
              ...
              @endif
                ...
                @if(Session::has('shop-owner-forgot-success'))
                    ...
                    @endif
                            {!! Form::open(array('url' => '/shop-owner-forgot-password', 'method' => 'post',  'class' => 'form-width-large row-fluid account-login input-100')) !!}
