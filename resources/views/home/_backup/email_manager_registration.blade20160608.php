        ...
        <td >
          ...
          <div align="center" style="background:#FFF;width:650px;margin:auto;padding:10px 0;border-bottom:solid 1px #a0a0a0;box-shadow:0 1px 0 0 #f0f0f0;">
            <table border="0" cellpadding="0" cellspacing="0" width="650">
              <tr>
                <td colspan="2" style="font:600 25px sans-serif;color:#555;text-transform:uppercase;text-shadow:none;padding:10px 20px;"> Thanks for Registering <hr></td>
               
              </tr>
              <tr>
                <td colspan="2" style="font:600 13px sans-serif;color:#555;text-transform:uppercase;text-shadow:none;padding:10px 20px;"> Welcome to Clarkin</td>
              ...
              <tr>
                ...
                <td style="font:300 13px sans-serif;color:#555;text-shadow:none;line-height:18px;padding:10px 20px;">
                  URL: <a href="{{ url('sales-login') }}">{{ url('sales-login') }}</a>
                  Username: {{ $email }} <br>
