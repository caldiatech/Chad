             ...
             <div class="uk-form-row">
                  <div class="uk-grid uk-form-horizontal uk-text-right">
                    ...
                    <div class="uk-width-large-5-10 uk-width-6-10 uk-padding-remove uk-float-right">
                       {!! Form::button('Add to cart <i class="fa fa-check yellow"></i>',array('class'=>'uk-button full-width uk-form-help-inline uk-button-large uk-button-yellow text-uppercase uk-text-bold uk-margin-small-left','type'=>'submit','name'=>'submit'))!!}                    </div>
                  </div>
              </div> 
            </div>
