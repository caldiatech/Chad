            ...
            <div class="uk-grid">
                <div class="uk-width-large-6-10 uk-width-1-1 uk-margin-large-bottom">
                    ...
                    <ul class="uk-tab uk-hidden" data-uk-tab="{connect:'#tabContent'}">
                        ...
                        <li class="uk-disabled" id="shipping"><a href="javascript:void(0)"><i class="uk-icon-envelope"></i> Shipping Address</a></li>
                         <li class="uk-disabled" id="shippingMethod"><a href="javascript:void(0)"><i class="uk-icon-envelope"></i> Shipping Method</a></li>
                           ...
                           <? /*<div id="billingError" style="display:none;" class="uk-text-danger">Fields mark with * are required</div>*/ ?>
                            <div class="uk-grid">
                                ...
                                <div class = "uk-width-large-1-2 uk-width-small-1-2 uk-margin-top">
                                    ...
                                    {!! Form::email('email',isset($billing->fldClientsBillingEmail) ? $billing->fldClientsBillingEmail : "",array('id'=>'email','required email','class'=>'form-control')) !!}
                                ...
                                <div class = "uk-width-large-1-2 uk-width-small-1-2 uk-margin-top">
                                    {!! Form::label('state', '* State',array('id'=>'stateBillingText')); !!}
                            ...
                            <? /*<div id="shippingError" style="display:none;" class="text-danger">Fields mark with * are required</div> */ ?>
                                <div class="uk-grid">
                                 ...
                                 <div class = "uk-width-medium-1-2 uk-width-small-1-1 uk-margin-top">
                                    ...
                                    <div class = "uk-width-medium-1-2 uk-width-small-1-1 uk-margin-top">
                                        {!! Form::label('shipping_state', '* State',array('id'=>'stateShippingText')) !!}
                ...
                <div class="uk-width-large-4-10 uk-width-medium-7-10  uk-width-small-1-1">
                                ...
                                <tr class="roboto">
                                    <td colspan="2">
                                        ...
                                        <div class="full-width">
                                            ...
                                            <div class="grey ">{!! $carts->product_sub_title !!}</div>
                                        </div>
                                    </td>
                    ...
                    <div class="next-btns uk-margin-top">
                        <a href="javascript:void(0)" class="uk-button roboto uk-button-primary full-width uk-margin-small-bottom " onClick="displayPrevious()" id="back" style="display:none;"><i class="fa fa-chevron-left"></i> Back</a>
                        <a href="javascript:void(0)" class="uk-button roboto uk-button-primary uk-button-grey full-width" onClick="displayNext()" id="next">NEXT</a>
                        <button type="submit" class="uk-button roboto uk-button-primary uk-button-grey full-width" name="submit" value="Pay Now" id="checkoutButton" style="display:none;">PLACE ORDER</button>
                    </div>
