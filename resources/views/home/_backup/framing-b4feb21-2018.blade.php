        ...
        @foreach($get_static_frames as $frame_key => $frame_obj)          
          ...
          echo '<div>
					...
					<figure class="uk-overlay uk-overlay-hover">
						<img class="frame-img" src="http://54.68.88.28/clarkin/public/uploads/photo-gallery/'.$this_frame_sku.'_l.jpg" width="500">
...
<div class="uk-modal show-rendered-canvas ">
    <div class="uk-modal-dialog uk-text-center loading " >
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(document).on('click','.get-canvas', function(){
			...
			$('#load_rendered_img').attr('src', "https://pod.cloud.graphikservices.com/renderEMF/render?imgUrl=http://54.68.88.28/clarkin/public/_admin/assets/images/clarking-adminlogo.png&imgHI=80&imgWI=80&maxW=800&maxH=800&m1b=0&off=0&&sku="+this_sku+"&frameW=8");
