    ...
    <div id="ccInformation">
                    ...
                    <div class="control-group uk-margin-top">	
                        ...
                        <div class="uk-grid controls">
                            <div class="uk-width-large-1-2 uk-width-medium-1-3 uk-width-small-1-2 uk-margin-top">
                            {!! Form::text('card_number','',array('required','placeholder'=>'Card Number','title'=>'Enter Card Number','class'=>'form-control','id'=>'card_number')) !!}
                            </div>
                            <div class="uk-width-large-1-4 uk-width-medium-1-4 uk-width-small-1-4 uk-margin-top">
                                {!! Form::text('card_cvv','',array('id'=>'card_cvv','required','class'=>'form-control','title'=>'Three or Four digits at back of your card','autocomplete'=>'off','maxlength'=>'4','id'=>'card_cvv','placeholder'=>'CVV')) !!}
                            </div>
                            <div class="uk-width-large-1-4 uk-width-medium-1-4 uk-width-small-1-4 uk-margin-top">
