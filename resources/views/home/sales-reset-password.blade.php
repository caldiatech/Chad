...
@section('content')
  ...
  <div class="uk-width-1-1 uk-margin-large  uk-margin-large-top">
                        ...
                        <div class="uk-width-medium-5-10 uk-width-1-1 uk-margin-top">
                            <div class="box-bordered padding-medium ">
                                ...
                                <p>{!! (isset($pages->fldPagesDescription)) ? $pages->fldPagesDescription: '' !!}</p>
                                 ...
                                 @endif
                                 {!! Form::open(array('url' => '/sales-new-password', 'method' => 'post',  'class' => 'row-fluid account-login input-100')) !!}
                                <div class="formbox">
           ...
           <input type="hidden" name="manager_id" value="{{ $manager->fldManagerID }}">
           <input type="hidden" name="hash" value="{{ $manager->fldManagerHashSecurity }}">
