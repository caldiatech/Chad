      ...
      <div class="uk-width-1-1 uk-width-medium-6-10 product-details-column">
            ...
            <ul id="product-detail-switcher" class="uk-switcher">
                <li class="uk-active"> <!-- frame -->
                    ...
                    @endif
                    {{number_format($product->fldProductImagePrice,2)}}
                </li>
                <? /* <li> <!-- mats -->
...
window.sortMeBy = (function(){
  ...
  function generateNewImageFrame() {
         ...
         var newSrc = "https://pod.cloud.graphikservices.com/renderEMF/render?imgUrl={{ url(PRODUCT_IMAGE_PATH.$product->fldProductSlug.'/'.MEDIUM_IMAGE.$product->fldProductImage) }}&m1b=1&off=0.375&sku="+$("#mainImage").attr('data-sku')+"&frameW="+$("#mainImage").attr('data-width');
