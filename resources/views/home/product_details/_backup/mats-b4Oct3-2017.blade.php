...
<div class="uk-width-1-1 uk-width-large-2-10 uk-display-inline form-radio-buttons">
...
<div class="uk-width-1-1 uk-width-medium-1-2 uk-width-large-2-10 ">
  <button class="uk-button-primary uk-text-large lato uk-button-large uk-width-1-1" id="chkNoMats" type="button">Remove</button>
</div>
</div>
<div class="uk-width-divider-blank uk-margin-small"></div>
...
<div class="uk-modal" id="matcolor">
    <div class="uk-modal-dialog bg-white uk-modal-dialog-large">
        <div class="uk-modal-header"><h3>Select Mat Color</h3></div>
            <div class="uk-grid uk-container-center modal-html">
        ...
        <div class="uk-modal-footer uk-hidden">       
...
<script>
  ...
  function selectedMat(sku,name,price) {      
    ...
    if(name != "") {
        ...
        $("#matDesc").html("  You have selected: " + name);
        //if($("#mat_value").val()==1) {
    ...
    // }
    has_selected = 1;
    $('#matcolor.uk-modal .uk-modal-footer').removeClass('uk-hidden');
  }
  $('#matcolor.uk-modal').on({
    ...
    'hide.uk.modal': function(){
        mat_selection_modal_closed();
    }
});

  function mat_selection_modal_closed() {
      //evt.preventDefault();
