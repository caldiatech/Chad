                  ...
                  @if($get_static_frames_count > 0)
                    @foreach($get_static_frames as $frame_key => $frame_obj)
                      ...
                      <div class="uk-width-1-3 frame-slider-subitem">
                        <img src="{{url('uploads/photo-gallery/'.$this_frame_sku.'_l.jpg')}}" width="175" height="175" onclick="changeFrame('{{$this_frame_sku}}','{{$this_frame_width}}',0,'{{$this_frame_title}}')" id="frameimg-{{$frame_all_counter}}" alt="{{$this_frame_title}}" data-filter="{{$attr}}" data-sku="{{$this_frame_sku}}" data-material="{{$this_frame_materials}}">
                      </div>                      
