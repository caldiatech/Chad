...
<div class="product-settings">
  ...
  <div class="uk-grid w100 uk-margin-remove uk-text-large remove-frame-section">
    <div class="uk-width-medium-1-2 frame-select-column uk-width-1-1 uk-float-left uk-padding-remove">
    ...
    <div class="uk-width-large-5-10 uk-float-right uk-display-inline uk-width-small-1-2  uk-width-1-1 uk-padding-remove remove-frame-column">
        <button class="uk-button-yellow uk-button uk-width-1-1 uk-button-grey uk-text-large uk-float-right lato  uk-button-large" id="chkNoFrame" type="button">
          Remove Frame
        </button>
    </div>
  </div>
  <div class="uk-grid select-photo-size uk-margin-remove uk-text-large remove-frame-section">
    <div class="uk-width-medium-1-2 uk-width-1-1 uk-padding-remove">
      Photo Size (Inches)
    </div>
  </div>
  <div class="uk-grid uk-margin-remove uk-text-large remove-frame-section">
    <div class="uk-width-medium-1-2 uk-width-1-1 uk-padding-remove">
