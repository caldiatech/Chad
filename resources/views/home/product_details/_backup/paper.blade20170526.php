...
<div class="uk-display-inline form-radio-buttons">
    ...
    */ ?>
    <input type="radio" value="canvas" class="uk-margin-medium-left custom-toggle" data-custom-toggle="print_on_canvas_toggler"  id="print_on_canvas" name="print_on" {{$canvasChecked}}> Print On Canvas</label>
</div> 
