...
<div class="product-settings">
  ...
  <div class="full-width bg-grey uk-margin uk-margin-large-top" id="toggle-frame-details">
    <div class="full-width padding-small border-bottom">
            ...
            <span class="light frame-sku-lbl uk-display-inline-block uk-margin-small-right frame-details-lbl frame-details-lbl">SKU: &nbsp;</span>
            <span class="bold text-uppercase  frame-sku-text uk-display-inline-block uk-margin-right frame-details-val"></span>
            ...
            <span class="bold text-uppercase  frame-liner-text uk-display-inline-block frame-details-val">Linen Liners Large Black Linen Liner</span>
