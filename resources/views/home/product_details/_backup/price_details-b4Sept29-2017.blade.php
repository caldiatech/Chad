<div class="uk-offcanvas" id="toggle-pice-details2">
    ...
    <div class="full-width padding-small border-bottom" id="paperInfo">
      ...
      <span class="uk-float-right ">
        <?php $wholesalePrice = 0; ?>
          $<span id="paperPrice">{{ number_format($wholesalePrice, 2) }}</span>
      </span>
      <br/>
    ...
    <div class="full-width padding-small bg-white  border-bottom">
        ...
        <span class="uk-float-right ">$<span id="merchandiseTotal">{{ number_format($merchandiseTotal + $product->fldProductImagePrice, 2) }}</span></span>
    </div>
    ...
    <div class="full-width padding-small bg-white  border-bottom">
        ...
        <span class="uk-float-right uk-text-bold">$<span id="grandTotalL">{{ number_format($discountTotal + $product->fldProductImagePrice, 2) }}</span></span>
    </div>
