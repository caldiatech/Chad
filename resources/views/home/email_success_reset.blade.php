            ...
            <table border="0" cellpadding="0" cellspacing="0" width="650">
              <tr>
               <tr>
                    ...
                    <p style="font:25px Arial, Helvetica, sans-serif;color:#555;">Your Password Has Been Changed</p></td>
                  </tr>
                  <tr>
                   <td height="45" style="padding:7px;color:#555;">This email confirms that your password has been changed.</td>   
                  </tr>
                  <tr>
