...
@section('content')
 ...
 {{-- */$active1="";$active2="";$active3="";$active4="class='active'";$active5="";/* --}}
            ...
            <div align='center' style='width:650px;margin:auto;padding:10px 0;'>
           			<table border='0' cellpadding='2' cellspacing='2' width='650' style='background:rgba(0,0,0,0.10);'>
                                    ...
                                    <tr>
                                        <td style='font:400 13px sans-serif;color:#555;text-align:left;text-transform:uppercase;text-shadow:none;padding:10px;'>
                                         {{ HTML::image('upload/products/'.$carts->product_id.'/_75_'.$carts->image) }}<br /><br />{{ $carts->product_name }} 
                                          ...
                                          <td style='font:400 13px sans-serif;color:#555;text-align:left;text-transform:uppercase;text-shadow:none;padding:10px;'>
                                          {{ $carts->quantity }} </td>
                                          <td style='font:400 13px sans-serif;color:#555;text-align:left;text-transform:uppercase;text-shadow:none;padding:10px;'>$ {{ number_format($total,2) }}</td>
                                     </tr>
						 @endforeach
						...
						<tr>
                            ...
                            <td style='font:400 12px sans-serif;color:#555;text-align:left;text-transform:uppercase;text-shadow:none;padding:5px 10px;'>$ {{ number_format($subtotal,2) }}</td>
                      </tr>
					...
					<tr>
                        ...
                        <td style='font:400 12px sans-serif;color:#555;text-align:left;text-transform:uppercase;text-shadow:none;padding:5px 10px;'>$ ( {{ $data->coupon_price }} ) 
                    	</td>
                    </tr>
                    @endif
