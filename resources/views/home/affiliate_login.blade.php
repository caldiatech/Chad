        ...
        <div class="uk-grid" style="margin-top: 4%;">
          <div class="uk-width-medium-2-3 uk-width-small-1-1">
            <div class="uk-container">
                ...
                @endif
                 {!! Form::open(array('url' => '/affiliate-login', 'method' => 'post',  'class' => 'row-fluid account-login input-100')) !!}
                <div class="formbox">
    ...
    <!--                            </div>-->
            ...
            <div class="uk-width-medium-1-3 uk-width-small-1-1">
                ...
                <div class=" uk-block box-bordered">
                    <div class="uk-container">
                        <h4 style="color:white;">New Affiliate</h4>
                        <p>Create an account as a Affiliate today.</p>
                        {!! Html::link('affiliate-registration', "Create an Account",array('class'=>'uk-button uk-button-primary')) !!}
                    </div>
                </div>
            </div>
        </div>
