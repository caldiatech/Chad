	                ...
	                <div class="uk-panel uk-panel-box">
	                	<div class="uk-grid">
	    						...
	    						<div class="uk-width-small-1-2 uk-width-1-1 ">
	    							...
	    							{!! Form::text('phone',$manager->fldManagerPhoneNo,array('id'=>'phone','required','class'=>'text','pattern'=>'\d{3}[\-]\d{3}[\-]\d{4}')) !!}
	    						...
	    						<div class="uk-width-small-1-2 uk-width-1-1 ">
	    							...
	    							{!! Form::email('email',$manager->fldManagerEmail,array('id'=>'email','required','class'=>'text')) !!}
					 ...
					 <div class="fileinput fileinput-new" data-provides="fileinput">
                                  <div class="fileinput-new uk-thumbnail" style="width: 200px; height: 150px;">
                                      @if($manager->fldManagerImage != "")
                                        {!! Html::image(MANAGER_IMAGE_PATH.$manager->fldManagerID.'/'.MEDIUM_IMAGE.$manager->fldManagerImage,'',array('style'=>'width: 200px; height: 140px;')) !!}
                                      @endif  
                                  </div>
	            ...
	            <div class="uk-width-small-1-1 ">
	                <div class="uk-grid uk-panel uk-panel-box normal">
	                	...
	                	<div class="uk-width-small-1-2 uk-width-1-1 uk-padding-v-normal">
	                    	...
	                    	{!! Form::text('promo_code',"PQR952Y0",array('id'=>'promo_code','class'=>'text','disabled'=>'disabled')) !!}
	                	</div>
