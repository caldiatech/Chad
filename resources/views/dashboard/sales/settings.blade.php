...
@section('content')	
   ...
   {!! Form::open(array('url' => '/dashboard/sales/settings', 'method' => 'post',  'class' => '','id'=>'profile_edit_form')) !!}
	            ...
	            <div class="uk-width-small-1-1 ">
	                <div class="uk-grid uk-panel uk-panel-box normal">
	                	...
	                	<div class="uk-width-large-1-4 uk-width-small-1-2 uk-width-1-1 uk-padding-v-normal" data-uk-button-checkbox>
	                		 <input type="hidden" name="mobile_alerts_value" id="mobile_alerts_value" value={{ $manager->fldManagerMobileAlerts }}>
