 ...
 <section id="order-history" class="section">
    	...
    	<div class="section-content uk-padding-remove uk-table" id="order-history-panel">
			<div class="uk-grid uk-panel uk-panel-box normal uk-margin-remove uk-padding-remove">
            	...
            	<div class="uk-width-large-1-10 uk-width-3-10 uk-padding-v-normal uk-th uk-visible-large">
            		<label  class="table-text">Cost<?php /*Payment<br><small>Invoice</small>*/ ?></label>
            	</div>
                <?php /* <div class="uk-width-large-1-10 uk-width-3-10 uk-padding-v-normal uk-th uk-visible-large">
                    <label  class="table-text">Shipping</label>
                </div>*/ ?>
            	<div class="uk-width-large-1-10 uk-width-3-10 uk-padding-v-normal uk-th uk-visible-large">	                		
            ...
            ?>
              ...
              @foreach($cart_order_array as $cart_order_no => $cart_order_item)
                ...
                if (isset($cart_order_item->fldCartCouponCodeCouponCode)) {
                  ...
                  //dd($shop_owner->fldShopOwnerFirstname.' '.$shop_owner->fldShopOwnerLastname);
                  //if ( !empty($shopownername) ) {
                  ...
                  if(isset($cart_order_total_array[$cart_order_no]) && ($cart_order_total_array[$cart_order_no] > 0)){
                    ...
                    // $cart_order_grand_total = $cart_order_grand_total_temp + $total_tax + $cart_shipping_total_array[$cart_order_no];
                    $cart_order_grand_total = $cart_order_grand_total_temp;
                  }

                $cart_shipping_total_temp = $cart_shipping_total_array[$cart_order_no];
                ?>
            ...
            <div class="uk-grid uk-panel uk-panel-box normal uk-margin-remove uk-padding-remove">
              ...
              <div class="uk-width-large-1-10  uk-width-small-1-2   uk-width-1-1  uk-padding-v-normal uk-td">                     
                <label  class="table-text light"><span class="mobile-label uk-hidden-large">Cost<?php /* Payment <br><small>Invoice</small>*/ ?></span>${!! number_format($cart_order_grand_total,2) !!}</label>
              </div>
              <?php /* <div class="uk-width-large-1-10  uk-width-small-1-2   uk-width-1-1  uk-padding-v-normal uk-td">                     
                <label  class="table-text light"><span class="mobile-label uk-hidden-large">Shipping</span>${!! number_format($cart_shipping_total_temp,2) !!}</label>
              </div>*/ ?>
              <div class="uk-width-large-1-10  uk-width-small-1-2   uk-width-1-1  uk-padding-v-normal uk-td">                     
              ...
              <div class="uk-width-large-1-10  uk-width-small-1-2   uk-width-1-1  uk-padding-v-normal uk-td">                     
                <label  class="table-text light"><span class="mobile-label uk-hidden-large">From</span>
                  {!! $shopownername !!}
                </label>
              </div>
                  ...
                  <div class="uk-grid uk-panel uk-panel-box normal uk-margin-remove uk-padding-remove">
                        ...
                        <div class="pos-rel uk-width-medium-1-2  uk-width-1-1    uk-padding-v-normal uk-td">                              
                              <span class="full-width ">Image</span>
                                {!! $cart_order_images !!}
                                <? /* <img id="productImage" src="{!!url(PRODUCT_IMAGE_PATH.$cart_order_item->fldProductSlug.'/'.SMALL_IMAGE.$cart_order_item->image)!!}" alt="" width="706" height="639" /> */ ?>
                        ...
                        <div class="pos-rel uk-width-medium-1-2  uk-width-1-1    uk-padding-v-normal uk-td">
                              ...
                              <div class="full-width uk-padding-v-normal uk-td">                            
                                    <label  class="full-width table-text light"><span class="mobile-label uk--large">Cost<?php /* Payments <br><small>Invoice</small>*/ ?></span><span id="productPayments">${!! number_format($cart_order_grand_total,2) !!}</span></label>
                              </div>
                              <?php /* <div class="full-width uk-padding-v-normal uk-td">                            
                                    <label  class="full-width table-text light"><span class="mobile-label uk--large">Shipping</span>
                                        <span id="productPayments">${!! number_format($cart_order_item->fldCartShippingPrice,2) !!}</span></label>
                              </div> */ ?>
                              <div class="full-width   uk-padding-v-normal uk-td ">                              
                              ...
                              <div class="full-width   uk-padding-v-normal uk-td">                              
                                    <label  class="table-text light"><span class="mobile-label uk--large">From</span><span id="clientFrom">{!! $shopownername !!}</span></label>
                              </div>
                              <div class="full-width  uk-padding-v-normal uk-td">                            
