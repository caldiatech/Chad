...
<? /*
@if($manager->fldManagerType == 1)
<li class="uk-icon-right @if($pages->slug == 'sales-rep') uk-active @endif">
	<a href="{{url('dashboard/'.$pages->category.'/sales-rep')}}"><i class="uk-icon-user uk-icon-justify"></i> <span class="menu-item-text">Sales Rep</span></a>  </li>	
@endif
*/ ?>
...
<? /* 
<li class="uk-icon-right @if($pages->slug == 'bank-routing') uk-active @endif"><a href="{{url('dashboard/'.$pages->category.'/bank-routing')}}"><i class="uk-icon-justify custom-icon-image custom-icon-bank-routing"></i> <span class="menu-item-text">Bank Routing</span></a> </li>
*/ ?>
