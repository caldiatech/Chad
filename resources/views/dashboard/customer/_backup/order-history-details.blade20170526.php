        ...
        <table class="uk-table">
         ...
         <table class="uk-table">
            ...
            @endforeach
                ...
                <tr>                   
                   <td colspan="4" class="uk-text-right uk-text-bold">SUB-TOTAL : </td>
                   <td>$ {{ number_format($cart[0]->subtotal,2) }}</td>                  
                </tr> 
                {{-- */$total = $cart[0]->subtotal + $data->fldCartTax;/* --}} 
                <tr>
                  
                   <td colspan="4" class="uk-text-right uk-text-bold">TAX : </td>
                   <td>$ {{ number_format($data->fldCartTax,2) }}</td>                  
                </tr> 
                 @if($data->fldCartShippingRateShippingAmount != "")
                 {{-- */$total = $total + $data->fldCartShippingRateShippingAmount;/* --}} 
                 <tr>
                   
                   <td  colspan="4" class="uk-text-right uk-text-bold">Shipping (  {{ $data->fldCartShippingRateShippingName }}  ) : </td>
                   <td>$ {{ number_format($data->fldCartShippingRateShippingAmount,2) }}</td>                  
                </tr> 
                @endif
                @if($data->fldCartCouponCodeCouponCode != "")
                      ...
                      <tr>
                         ...
                         <td colspan="4" class="uk-text-right uk-text-bold">DISCOUNT CODE ( {{ $data->fldCartCouponCodeCouponCode }} ) : </td>
                         <td>$ ( - {{ number_format($data->fldCartCouponCodeCouponPrice,2) }} )</td>                  
                      </tr>
                @endif      

                 <tr>
               
                   <td colspan="4" class="uk-text-right uk-text-bold">GRAND TOTAL: </td>
