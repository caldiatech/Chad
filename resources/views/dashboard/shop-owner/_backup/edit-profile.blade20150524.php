	                ...
	                <div class="uk-panel uk-panel-box">
	                	<div class="uk-grid">
	                			<div class="uk-width-large-1-2 uk-width-1-2 ">
	                    			...
	                    			{!! Form::text('firstname',"Joseph Michael",array('id'=>'firstname','required','class'=>'text')) !!}
	                			</div>
	                			<div class="uk-width-large-1-2 uk-width-1-2 ">
	                    ...
	                    <div class="uk-panel-content address-info-content">
	                    	...
	                    	<div class="uk-grid">
	                			...
	                			<div class="uk-width-large-1-4 uk-width-1-2 ">
	                    			...
	                    			{!! Form::text('street',"500 West Broadway",array('id'=>'street','required','class'=>'text')) !!}
	                			</div>
	                			<div class="uk-width-large-1-4 uk-width-1-2 ">
	                			...
	                			<div class="uk-vertical-divider full-width uk-margin"></div>
	                			<div class="u uk-width-1-2">
	                				{!! Form::label('career', '* Career',array('class'=>'lbl' )); !!}
	                    			{!! Form::text('career',"Professional Photographer",array('id'=>'career','required','class'=>'text')) !!}
	                			</div>
        			...
        			<div class="uk-vertical-divider full-width uk-margin"></div>
	                    ...
	                    <div class="uk-panel-content address-info-content">
	                    	...
	                    	<div class="uk-grid">
	                			...
	                			<div class="uk-vertical-divider full-width uk-margin">
