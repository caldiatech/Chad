	                ...
	                <div class="uk-panel uk-panel-box">
	                	<div class="uk-grid">
	    						...
	    						<div class="uk-width-small-1-2 uk-width-1-1 ">
	    							...
	    							{!! Form::text('phone',$shopOwner->fldShopOwnerPhoneNo,array('id'=>'phone','required','class'=>'text','pattern'=>'\d{3}[\-]\d{3}[\-]\d{4}')) !!}
	    						...
	    						<div class="uk-width-small-1-2 uk-width-1-1 ">
	    							...
	    							{!! Form::email('email',$shopOwner->fldShopOwnerEmail,array('id'=>'email','required','class'=>'text')) !!}
					 ...
					 <div class="fileinput fileinput-new" data-provides="fileinput">
                                  <div class="fileinput-new uk-thumbnail" style="width: 200px; height: 150px;">
                                      @if($shopOwner->fldShopOwnerImage != "")
                                        {!! Html::image(SHOP_OWNER_IMAGE_PATH.$shopOwner->fldShopOwnerID.'/'.MEDIUM_IMAGE.$shopOwner->fldShopOwnerImage,'',array('style'=>'width: 200px; height: 140px;')) !!}
                                      @endif  
                                  </div>
	...
	<section id="banking-info" class="section">
    	<h2 class="section-header uk-h2"><i class="uk-icon-briefcase uk-icon-justify"></i> <span class="title-text">Banking Information</span>
    	  @if($shopOwner->fldShopOwnerBrainTreeMerchantID != "")
    			({{ $shopOwner->fldShopOwnerBrainTreeMerchantID }})       			
    		@endif	
