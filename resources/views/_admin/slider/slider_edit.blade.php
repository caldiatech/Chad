...
@section('content')
   <article>
  	<div id=page_control>
       <div class="col1">
	       {!! Html::link('/dnradmin/pages/edit/72','The works page') !!}  &raquo; {!! Html::link('/dnradmin/slider','Slider') !!}  &raquo; Update Slider   
        </div>  
    </div>
    
  	
    
   {!! Form::open(array('url' => '/dnradmin/slider/edit/'.$slider->fldSliderID, 'method' => 'post', 'id' => 'pageform', 'files' => true)); !!}
    ...
    @endif
      ...
      <ul>
        ...
        <li class=boxfields>
          <dl>
            <dt>Slider Name</dt>
            <dd>{!! Form::text('name',$slider->fldSliderName,array('size'=>'50','id'=>'name')) !!}
            ...
            <dd>{!! Form::text('links',$slider->fldSliderButtonLink,array('size'=>'50')) !!}
          ...
          <dl>
            ...
            <dd>{!! Form::text('linkname',$slider->fldSliderButtonLinkText,array('size'=>'50')) !!}
     ...
     <ul>
        ...
        <li class=boxfields>
            <dl>
              <dt>Title</dt>
              <dd>{!! Form::text('title1',$slider->fldSliderTitle1,array('size'=>'50','class'=>'required','id'=>'title1')) !!}
            ...
            <dl>
              <dt>Description</dt>
              <dd>{!! Form::textarea('description1',$slider->fldSliderContent1,array('style'=>'width:320px;height:100px;','class'=>'required','id'=>'description1')) !!}
      ...
      <ul>
        ...
        <li class=boxfields>
            <dl>
              <dt>Title</dt>
              <dd>{!! Form::text('title2',$slider->fldSliderTitle2,array('size'=>'50','class'=>'required','id'=>'title2')) !!}
            ...
            <dl>
              <dt>Description</dt>
              <dd>{!! Form::textarea('description2',$slider->fldSliderContent2,array('style'=>'width:320px;height:100px;','class'=>'required','id'=>'description2')) !!}
      ...
      <ul>
        ...
        <li class=boxfields>
            <dl>
              <dt>Title</dt>
              <dd>{!! Form::text('title3',$slider->fldSliderTitle3,array('size'=>'50','class'=>'required','id'=>'title3')) !!}
            ...
            <dl>
              <dt>Description</dt>
              <dd>{!! Form::textarea('description3',$slider->fldSliderContent3,array('style'=>'width:320px;height:100px;','class'=>'required','id'=>'description3')) !!}
            ...
            <dd>
                <div class="fileinput fileinput-new" data-provides="fileinput">
                  <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                      @if($slider->fldSliderImage != "")
                        {!! Html::image(SLIDER_IMAGE_PATH.$slider->fldSliderImage,'',array( 'width' => 200 )) !!}
                      @endif  
                  </div>
