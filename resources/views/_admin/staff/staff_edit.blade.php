...
@section('content')
   ...
   {!! Form::open(array('url' => '/dnradmin/staff/edit/'.$staff->fldStaffID, 'method' => 'post', 'id' => 'pageform', 'files' => true)); !!}
    ...
    @endif	
      <ul>
        ...
        <li class=boxfields>
           <dl>
            <dt>First name</dt>
            <dd>{!! Form::text('firstname',$staff->fldStaffFirstname,array('size'=>'50','id'=>'firstname')) !!}
            	<br />
           ...
           <dl>
            <dt>Last name</dt>
            <dd>{!! Form::text('lastname',$staff->fldStaffLastname,array('size'=>'50','id'=>'lastname')) !!}
            	<br />
          ...
          <dl>
            <dt>Department</dt>
            <dd>{!! Form::text('department',$staff->fldStaffDepartment,array('size'=>'50','id'=>'department')) !!}
            	<br />
      ...
      <ul>
        <li>Biography</li>
        <li class=boxfields>
        	{!! Form::textarea('description',$staff->fldStaffDescription,array('id'=>'description','cols'=>'110')) !!}
            <br />
            ...
            <dd>
                <div class="fileinput fileinput-new" data-provides="fileinput">
                  <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                      @if($staff->fldStaffImage != "")
                        {!! Html::image('upload/staff/'.$staff->fldStaffID.'/'.$staff->fldStaffImage) !!}
                      @endif  
                  </div>
