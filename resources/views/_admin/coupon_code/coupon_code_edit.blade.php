...
@section('content')
   <article>
  	<div id=page_control>
       <div class="col2">
	       {!! Html::link('/dnradmin/coupon_code',COUPONCODE_MANAGEMENT) !!} &raquo; Update {{ COUPONCODE_MANAGEMENT }}
        </div>
    </div>
    
  	  
    
   {!! Form::open(array('url' => '/dnradmin/coupon_code/edit/'.$coupon->fldCouponCodeID, 'method' => 'post', 'id' => 'pageform', 'files' => true,'class'=>'uk-form')); !!}
            ...
            <ul>
               ...
               <li class="boxfields">
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                          {!! Form::text('code',$coupon->fldCouponCode,array('size'=>'50','class'=>'required')) !!}
                  ...
                  <!--  <div class="uk-grid">
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                          {!! Form::text('percentage',$coupon->fldCouponCodePercentage,array('size'=>'50')) !!} %
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                          {!! Form::checkbox('isFreeShipping',1,$coupon->fldCouponCodeIsFreeShipping == 1 ? true : false,['class'=>'check-select']) !!}
                      </div>
                   </div>
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                           <input type="text" data-uk-datepicker="{format:'YYYY-MM-DD'}" name="expiration_date" value="{{$coupon->fldCouponCodeExpirationDate}}">
