...
@section('content')
   <article>
    <div id=page_control>
      <div class="col2">
          ...
          {!! Html::link('/dnradmin/sales-rep',SALESREP_MANAGEMENT) !!} &raquo; Add {{ SALESREP_MANAGEMENT }}
   ...
   {!! Form::open(array('url' => '/dnradmin/sales-rep/new', 'method' => 'post', 'id' => 'pageform', 'files' => true,'class'=>'uk-form')) !!}
     @if (Session::has('success'))
           <div class="uk-alert uk-alert-success">{!!Session::get('success')!!}</div>
    @endif    
     @if(Session::has('email_error')) 
      <div class="uk-alert uk-alert-error">{!!Session::get('email_error')!!}</div>
    @endif
