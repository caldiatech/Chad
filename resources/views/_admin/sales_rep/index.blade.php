...
@section('content')	
    ...
    <div id="page_control">      
    	<div class="col2">	       
         <a href="{{url('dnradmin/sales-rep/new')}}"><img src="{{url('_admin/assets/images/icons/icon_add.png')}}"> Add new {{ SALESREP_MANAGEMENT }}</a>
        </div>
        <div class="col1">
        	{{ SALESREP_MANAGEMENT }}
        </div>   
      ...
      <tbody id="Searchresult">
                    ...
                    @endif 
                        ...
                        <tr>
                           ...
                           <td align="right">                                                                     
                             <a href="{{url('dnradmin/sales-rep/edit/'.$managers->fldManagerID)}}" alt="Modify Sales Rep"><i class="pe-7s-pen action-icon"></i></a>                         
