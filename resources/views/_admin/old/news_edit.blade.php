...
@section('content')
   ...
   {{ Form::open(array('url' => '/dnradmin/news/edit/'.$news->id, 'method' => 'post', 'id' => 'pageform', 'files' => true)); }}
     @if($success == 1) 
     ...
     <table border="0" width="1000px;" style="margin-bottom:10px; padding:10px 10px">
        ...
        <li class=boxfields style="width:705px;">
           <dl style="width:705px;">
            ...
            <dd style="width:525px;">{{ Form::text('title',$news->name,array('size'=>'50')) }}</dd>
          </dl> 
          <dl style="width:705px;">
            <dt style="width:100px;">Date</dt>
            <dd style="width:525px;">{{ Form::text('news_date',$news->news_date,array('size'=>'50','id'=>'news_date')) }}</dd>
          </dl>                    
        </li>
      ...
      <ul style="width:725px;">
        ...
        <li class=boxfields style="width:705px;">
        	{{ Form::textarea('description',$news->description,array('id'=>'mods2')) }}
        </li>
      </ul>
      </td>
