...
@section('content')
   <article>
    <div id=page_control>
      <div class="col1">
          ...
          {!! Html::link('/dnradmin/manager',' Sales Manager') !!} &raquo; Add Sales Manager
   ...
   {!! Form::open(array('url' => '/dnradmin/manager/new', 'method' => 'post', 'id' => 'pageform', 'files' => true)) !!}
      ...
      <ul>
        ...
        <dl>
          ...
          <dl>
           ...
           <dl>
            <dt>Status</dt>
            <dd>{!! Form::radio('status', 1,0) !!} Pending {!! Form::radio('status',2,1) !!} Active</dd>
          </dl>
          <dl>              
            <dt>Promo Code</dt>
