...
@section('content')	
    ...
    <div id="page_control">      
    	<div class="col2">	       
         <a href="{{url('dnradmin/manager/new')}}"><img src="{{url('_admin/assets/images/icons/icon_add.png')}}"> Add new Sales Manager</a>
        </div>
        <div class="col1">
        	Sales Manager
        </div>   
      ...
      <tbody id="Searchresult">
                    ...
                    @endif 
                        ...
                        <tr>
                           ...
                           <td align="right">                                                                     
                             <a href="{{url('dnradmin/manager/edit/'.$managers->fldManagerID)}}" alt="Modify Sales Manager"><img src="{{url('_admin/assets/images/icons/page_modify.png')}}"></a>                         
