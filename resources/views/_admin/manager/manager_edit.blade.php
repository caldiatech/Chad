...
@section('content')
   <article>
    <div id=page_control>
      <div class="col2">
          ...
          {!! Html::link('/dnradmin/manager',SALESMANAGER_MANAGEMENT) !!} &raquo; Update {{ SALESMANAGER_MANAGEMENT }}
   ...
   {!! Form::open(array('url' => '/dnradmin/manager/edit/'.$manager->fldManagerID, 'method' => 'post', 'id' => 'pageform', 'files' => true,'class'=>'uk-form')) !!}
    ...
    @endif
       ...
       <div class="uk-grid">
        <div class="uk-width-large-1-1 uk-width-small-1-1">
            <ul>
               <li>{{ SALESMANAGER_MANAGEMENT }} Information</li>
               <li class="boxfields">

                     <div class="uk-grid">
                      <div class="uk-width-large-1-10 uk-width-small-1-1">First name</div>
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::text('firstname',$manager->fldManagerFirstname,array('size'=>'50','class'=>'required','id'=>'firstname')) !!}
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::text('lastname',$manager->fldManagerLastname,array('size'=>'50','class'=>'required','id'=>'lastname')) !!}
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::text('phone',$manager->fldManagerPhoneNo,array('size'=>'50','class'=>'phone_us')) !!} 
                      </div>
                   </div>
                    ...
                    <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::text('address',$manager->fldManagerAddress,array('size'=>'50','class'=>'required','id'=>'address')) !!}
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         <strong>{{$manager->fldManagerPromoCode}}</strong>
                      </div>
                   </div>
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 radio-cat">
                         {!! Form::radio('status', 1,$manager->fldManagerStatus==1 ? 1 :0) !!} Pending {!! Form::radio('status',2,$manager->fldManagerStatus==2 ? 1 :0) !!} Active
                      </div>
                   </div>
