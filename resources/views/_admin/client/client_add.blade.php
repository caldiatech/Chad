...
@section('content')
   <article>
  	<div id=page_control>
    	<div class="col2">
	       {!! Html::link('/dnradmin/client',CLIENT_MANAGEMENT) !!}  &raquo; Add new {{ CLIENT_MANAGEMENT }}   
        </div>   
    </div>
    
  	
    
   {!! Form::open(array('url' => '/dnradmin/client/new', 'method' => 'post', 'id' => 'pageform', 'files' => true,'class'=>'uk-form')); !!}
               ...
               <li class="boxfields">
                    ...
                    <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::text('firstname','',array('size'=>'50','class'=>'required','required','id'=>'firstname')) !!}
                    ...
                    <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::text('lastname','',array('size'=>'50','class'=>'required','required','id'=>'lastname')) !!}
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::text('phone','',array('size'=>'50','pattern'=>'\d{3}[\-]\d{3}[\-]\d{4}','class'=>'required','required')) !!} <small>eg 123-456-7890</small></dd>
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::email('email','',array('size'=>'50','class'=>'required','id'=>'email','required')) !!}
                    ...
                    <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         <input type="password" name="password" id="password-fld" size=50 class="required" required>
                          <table border=0>
                              <tr>
