...
@section('content')	
    ...
    <div id="page_control">      
    	<div class="col2">	       
         <a href="{{url('dnradmin/client/new')}}"><img src="{{url('_admin/assets/images/icons/icon_add.png')}}"> Add new {{ CLIENT_MANAGEMENT }}</a>
        </div>
        <div class="col1">
        	{{ CLIENT_MANAGEMENT }}
        </div>   
    ...
    <table id="page_manager" class="parennt-table uk-table-hover">
      <thead>
        <tr class="headers nodrag uk-table">
          ...
          <th width="300" data-sort="string"><span class="id">First name</span> <div class="sort"></div></th>
          <th width="300" data-sort="string"><span class="id">Last name</span> <div class="sort"></div></th>
          <th width="450" data-sort="string"><span class="id">Email Address</span> <div class="sort"></div></th>
          <th width="300" data-sort="string"><span class="id">Type</span> <div class="sort"></div></th>
      ...
      <tbody id="Searchresult">
                    ...
                    @endif 
                        ...
                        <tr id="{{ $clients->fldClientID}}">
                           ...
                           <td>{!! ($clients->is_guest == 1)? 'Guest': '<b>Registered</b>' !!} </td>
                           <td align="right">                                        
                             <a href="{{url('dnradmin/client/edit/'.$clients->fldClientID)}}" alt="Modify Client"><i class="pe-7s-pen action-icon"></i></a>                         
