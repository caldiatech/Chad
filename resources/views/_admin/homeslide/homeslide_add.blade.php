...
@section('content')
   <article>
  	<div id=page_control>
    	<div class="col2">
	       {!! Html::link('/dnradmin/homeslides',HOMESLIDE_MANAGEMENT) !!}  &raquo; Add new {{ HOMESLIDE_MANAGEMENT }}         
        </div>   
    </div>
    

    
   {!! Form::open(array('url' => '/dnradmin/homeslides/new', 'method' => 'post', 'id' => 'pageform', 'files' => true,'class'=>'uk-form')); !!}
   @if (Session::has('success'))
    ...
    @if($errors->homeslide->first('image') && $errors->homeslide->first('image')=="validation.img_min_size")
        <div class="uk-alert uk-alert-error">{!!IMAGES_DIMENSION_ERROR!!}</div>
    @endif
            ...
            <ul>
               ...
               <li class="boxfields">
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                          {!! Form::text('linkname','',array('size'=>'50')) !!}
