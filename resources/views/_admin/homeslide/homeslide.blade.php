...
@section('content')
    ...
    <div id="page_control"> 
    	<div class="col2">                   	       
         <a href="{{url('dnradmin/homeslides/new')}}"><img src="{{url('_admin/assets/images/icons/icon_add.png')}}"> Add {{ HOMESLIDE_MANAGEMENT }}</a>
        </div>   
        <div class="col1">
        	{{ HOMESLIDE_MANAGEMENT }}
        </div>
    </div>
    ...
    {!! Form::open(array('url' => '/dnradmin/homeslide/', 'method' => 'post', 'id' => 'pageform', 'files' => true,'class'=>'uk-form')); !!}
    ...
    <table id="page_manager" class="parennt-table uk-table-hover">
      ...
      <tbody id="Searchresult">     
                    ...
                    <tr id="{{$homeslides->fldHomeSlideID.'_'.$homeslides->fldHomeSlidePosition}}">
                       ...
                       <td align="right">        
                         <a href="{{url('dnradmin/homeslides/edit/'.$homeslides->fldHomeSlideID)}}" alt="Modify Home Slide"><i class="pe-7s-pen action-icon"></i></a>                         
