    ...
    <div class="uk-grid">
                                        ...
                                        <ul id="required_option_assets">
                                            ...
                                            <li class="boxfields">
                                                ...
                                                <div id="options{!!$option->fldOptionsID!!}" {!!
                                                    DB::table('tblProductOptions')->
                                                    where('fldProductOptionsOptionsID','=',$option->fldOptionsID)->count()>=1
                                                    ? "" : "display:none;" !!}" id="options{!!$option->fldOptionsID!!}>
                                                </div>
                                                <p style="padding:5px 5px; background:#666; color:#fff">
                                                    <strong>{!!$option->fldOptionsName!!}</strong></p>
        ...
        <ul id="required_category">
                ...
                <li class="boxfields">
                    ...
                    <select name="category" id="category" required>
                        ...
                        @foreach($category as $category_item)
                            <option value="{{ $category_item->fldCategoryID }}">
                                {{ $category_item->fldCategoryName; }}</option>
                        @endforeach
                    </select>
                </li>
            </ul> -->
            ...
            <ul>
                ...
                <li class="boxfields">
                    Frame Size 1: <input type="text" name="framelow_1"
                        value="{{ old('framelow_1') }}"> <br> &nbsp;
                </li>
                <li class="boxfields">
                    Frame Size 2: <input type="text" name="framelow_2"
                        value="{{ old('framelow_2') }}"> <br> &nbsp;
                </li>
                <li class="boxfields">
                    Frame Size 3: <input type="text" name="framelow_3"
                        value="{{ old('framelow_3') }}"> <br> &nbsp;
                </li>
                <li class="boxfields">
                    Frame Size 4: <input type="text" name="framelow_4"
                        value="{{ old('framelow_4') }}"> <br> &nbsp;
                </li>
                <li class="boxfields">
                    Frame Size 5: <input type="text" name="framelow_5"
                        value="{{ old('framelow_5') }}"> <br> &nbsp;
                </li>
                <li class="boxfields">
                    Frame Size 6: <input type="text" name="framelow_6"
                        value="{{ old('framelow_6') }}"> <br> &nbsp;
                </li>
                <li class="boxfields">
                    Frame Size 7: <input type="text" name="framelow_7"
                        value="{{ old('framelow_7') }}"> <br> &nbsp;
                </li>
                <li class="boxfields">
                    Frame Size 8: <input type="text" name="framelow_8"
                        value="{{ old('framelow_8') }}"> <br> &nbsp;
                </li>
            </ul>
