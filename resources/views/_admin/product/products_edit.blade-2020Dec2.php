    ...
    <div class="uk-grid">
        ...
        <div class="uk-width-large-3-10 uk-width-small-1-1">
            ...
            <ul>
               ...
               <li class="boxfields">
                    Shipping Cost 5: <input type="text" name="shipping_cost5" value="{{number_format($products->shipping_proc_fee5,2)}}"> <br> &nbsp;
               </li>
               <li class="boxfields">
                    Shipping Cost 6: <input type="text" name="shipping_cost6" value="{{number_format($products->shipping_proc_fee6,2)}}"> <br> &nbsp;
               </li>
               <li class="boxfields">
                    Shipping Cost 7: <input type="text" name="shipping_cost7" value="{{number_format($products->shipping_proc_fee7,2)}}"> <br> &nbsp;
               </li>
               <li class="boxfields">
                    Shipping Cost 8: <input type="text" name="shipping_cost8" value="{{number_format($products->shipping_proc_fee8,2)}}"> <br> &nbsp;
               </li>
            </ul> */ ?>
