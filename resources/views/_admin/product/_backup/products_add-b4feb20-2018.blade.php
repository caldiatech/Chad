    ...
    <div class="uk-grid">
            ...
            <ul>
               ...
               <li class="boxfields">
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                            <!--- {!! Form::text('sub_title','',array('size'=>'50','class'=>'required','id'=>'sub_title')) !!} -->
                              {!! Form::text('sub_title','',array('size'=>'50','id'=>'sub_title')) !!}
                     ...
                     <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                         {!! Form::text('old_price','',array('size'=>'50')) !!}
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                           {!! Form::text('weight','',array('size'=>'50','class'=>'required')) !!}
        ...
        <div class="uk-width-large-3-10 uk-width-small-1-1">
            ...
            <ul>
              ...
              <ul>
               <li>Options</li>
               <li class="boxfields"><div id="options{!!$option->fldOptionsID!!}" class="display:none"></div> 
