            ...
            <ul>
               ...
               <li class="boxfields">
                   ...
                   <div class="uk-grid">
                      ...
                      <div class="uk-width-large-6-10 uk-width-small-1-1 ">
                            {!! Form::text('sub_title','',array('size'=>'50','class'=>'required','id'=>'sub_title','required')) !!}
                               ...
                               <li class="boxfields">
                                   <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <div>
                                                  ...
                                                  <span class="fileinput-exists">Change</span><input type="file" name="image" required="required"></span>
        ...
        <div class="uk-width-large-3-10 uk-width-small-1-1">
            ...
            <ul id="required_options">
              ...
              <ul id="required_option_assets">
               <li>Options</li>
               <li class="boxfields"><div class="required-notification uk-display-block"></div><div id="options{!!$option->fldOptionsID!!}" class="display:none"></div> 
