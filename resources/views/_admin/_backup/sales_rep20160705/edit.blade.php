...
@section('content')
   <article>
    <div id=page_control>
      <div class="col1">
          ...
          {!! Html::link('/dnradmin/sales-rep',' Sales Rep') !!} &raquo; Update Sales Rep
   ...
   {!! Form::open(array('url' => '/dnradmin/sales-rep/edit/'.$manager->fldManagerID, 'method' => 'post', 'id' => 'pageform', 'files' => true)) !!}
