...
@section('content')	
    ...
    <div id="page_control">      
    	<div class="col2">	       
         <a href="{{url('dnradmin/sales-rep/new')}}"><img src="{{url('_admin/assets/images/icons/icon_add.png')}}"> Add new Sales Rep</a>
        </div>
        <div class="col1">
        	Sales Rep
        </div>   
                        ...
                        <tr>
                           ...
                           <td>
                              <? /*<strong>{{ number_format($managers->fldManagerCommission,2)  }}</strong>*/ ?>
                           		{!! Html::link('/dnradmin/sales-rep/sales/'.$managers->fldManagerID,number_format($managers->fldManagerCommission,2)) !!} 
								 <br />
								  Merchant ID<br />
                           ...
                           <td align="right">                                                                     
                             <a href="{{url('dnradmin/sales-rep/edit/'.$managers->fldManagerID)}}" alt="Modify Sales Rep"><img src="{{url('_admin/assets/images/icons/page_modify.png')}}"></a>                         
                             <a href="{{url('dnradmin/sales-rep/delete/'.$managers->fldManagerID)}}" alt="Delete Sales Rep" onClick="return confirm(&quot;Are you sure you want to remove this Sales Rep?\n\nPress OK to delete.\nPress Cancel to go back without deleting the Sales Rep.\n&quot;)"><img src="{{url('_admin/assets/images/icons/page_delete.png')}}"></a>                         
                           </td>
                        </tr>
