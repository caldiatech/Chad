...
@section('content')
   <article>
  	<div id=page_control>
    	<div class="col1">
       	  ...
       	  {!! Html::link('/dnradmin/shop-owner',' Shop Owner') !!} &raquo; Add Shop Owner
   ...
   {!! Form::open(array('url' => '/dnradmin/shop-owner/new', 'method' => 'post', 'id' => 'pageform', 'files' => true)) !!}
    ...
    <table border="0" width="1000px;" style="margin-bottom:10px; padding:10px 10px">
      ...
      <ul style="width:725px;">
        ...
        <dl>
            <dt>First name</dt>
            <dd style="width:547px !important;">{!! Form::text('firstname','',array('size'=>'50','class'=>'required')) !!}
           ...
           <dl>
            <dt>Last name</dt>
            <dd style="width:547px !important;">{!! Form::text('lastname','',array('size'=>'50','class'=>'required')) !!}
           ...
           <dl>
            <dt>Email Address</dt>
            <dd style="width:547px !important;">{!! Form::email('email','',array('size'=>'50','class'=>'required')) !!}
          ...
          <dl>
            <dt>Phone no</dt>
            <dd style="width:547px !important;">{!! Form::text('phone','',array('size'=>'50','pattern'=>'\d{3}[\-]\d{3}[\-]\d{4}')) !!} <span>eg 123-456-7890</span></dd>
          </dl>
          <dl>
            <dt>Address</dt>
            <dd style="width:547px !important;">{!! Form::text('address','',array('size'=>'50')) !!}
          ...
          <dl>
            <dt>Gender</dt>
            <dd style="width:547px !important;">{!! Form::radio('gender', 'Male',1) !!} Male {!! Form::radio('gender', 'Female') !!} Female</dd>
          </dl>
          <dl>
            <dt>Birthdate</dt>
            <dd style="width:547px !important;"><input type="text" data-uk-datepicker="{format:'YYYY-MM-DD'}" name="bday" size="50"></dd>
          </dl>
          <dl>          		
            <dt>Promo Code</dt>
            <dd style="width:547px !important;"><strong>{!! $promocode !!}</strong></dd>
          </dl>  
                      ...
                      <div id="searchResult" style="height:327px;width:245px; overflow:scroll">
                          <table border="0">  
                              @foreach($manager as $managers)
                                  <tr>
                                       <td><input type="radio" name="manager_id" value="{{$managers->fldManagerID}}" {{$managers->fldManagerID==$managerId ? 'checked' : ""}} /> {{ $managers->fldManagerFirstname . ' ' . $managers->fldManagerLastname}}</td>
                                    </tr>
                              @endforeach
                           </table>
                      </div>      
