...
@section('content')	
    ...
    <div id="page_control">      
    	<div class="col2">	       
         <a href="{{url('dnradmin/shop-owner/new')}}"><img src="{{url('_admin/assets/images/icons/icon_add.png')}}"> Add new Shop Owner</a>
        </div>
        <div class="col1">
        	Shop Owner
        </div>   
      ...
      <tbody id="Searchresult">
                    ...
                    @endif 
                        ...
                        <tr>
                           ...
                           <td align="right">                                                                     
                             <a href="{{url('dnradmin/shop-owner/edit/'.$shopOwners->fldShopOwnerID)}}" alt="Modify Shop Owner"><img src="{{url('_admin/assets/images/icons/page_modify.png')}}"></a>                         
