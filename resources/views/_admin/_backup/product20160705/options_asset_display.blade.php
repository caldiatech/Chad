			   	...
			   	<table id="page_manager{!!$option_id!!}1" style="width:225px !important; border:none; margin-top:-5px">     
                        @foreach($options as $optionss)
                        	<tr id="{{$optionss->fldOptionsAssetsID.'_'.$optionss->fldOptionsAssetsPosition}}">
                                ...
                                <td style="padding: 5px 3px;">{{  $optionss->fldOptionsAssetsWidth }} x {{  $optionss->fldOptionsAssetsHeight }}</td>
			   ...
			   <tr id="assets{!!$optionss->fldOptionsID!!}">
                        ...
                        <div style="margin-bottom:15px; margin-left:55px;padding: 5px 3px;">
                        	<button type="button" name="button" onClick="addAssetsOptions({!!$option_id!!},{!!$product_id!!})">Add New Options Assets</button>
                         </div>
