...
@section('content')
   <article>
  	<div id=page_control>
    	<div class="col1">
	       {!! Html::link('/dnradmin/client','Clients') !!}  &raquo; Add new client
        </div>
    </div>



   {!! Form::open(array('url' => '/dnradmin/client/new', 'method' => 'post', 'id' => 'pageform', 'files' => true)); !!}
    ...
    @endif
      <ul>
        ...
        <li class=boxfields>
          <dl>
            <dt>First name</dt>
            <dd>{!! Form::text('firstname','',array('size'=>'50','class'=>'required','required')) !!}
           ...
           <dl>
            <dt>Last name</dt>
            <dd>{!! Form::text('lastname','',array('size'=>'50','class'=>'required','required')) !!}
	   ...
	   <dl>
            <dt>Phone Number</dt>
            <dd>
                 {!! Form::text('phone','',array('size'=>'50','pattern'=>'\d{3}[\-]\d{3}[\-]\d{4}','class'=>'required','required')) !!} <span>eg 123-456-7890</span></dd>
           ...
           <dl>
            <dt>Email Address</dt>
            <dd>{!! Form::email('email','',array('size'=>'50','class'=>'required','id'=>'email','required')) !!}
