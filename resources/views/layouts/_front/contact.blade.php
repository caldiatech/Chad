...
<div id="container">
    ...
    <!-- CONTENTS START-->
    <div class="uk-width-1-1 uk-cover-background header-image" style="background-image:url('http://104.197.67.179/clarkin/public/uploads/pages/large/about-us-header.jpg')">
        <div class="uk-container uk-container-center">
          <h1>Contact Us</h1>
          <!--<h2 class="sub-title">Tell us you want to inquire and we guarantee the best of our collections</h2>-->
        </div>
      </div>
