...
<head>
  ...
  !!} {!! Html::script('_front/assets/js/jquery-1.9.1.min.js') !!} {!! HTML::script('_front/plugins/uikit/js/uikit.min.js')!!}
  <!--[if lt IE 9]>
...
<body>
  <div id="container">
    ...
    <div class="home-slide uk-panel full-width">
      {{-- */ $slide_ctr = 1; $slide_acc_ctr = 0; $slide_item_ctr = 0; $slide_item_array = array(); $slider_accordion = array();
