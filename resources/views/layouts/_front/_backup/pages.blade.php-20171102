...
<title> {{ $pages->fldPagesMetaTitle != "" ? $pages->fldPagesMetaTitle  : $pages->fldPagesName .' | '. $settings->fldAdministratorSiteName }} </title>
...
<div id="container" class="page page-{{$pages->fldPagesSlug}} page-id-{{$pages->fldPagesID}}">
    ...
    <div class="grid">
      ...
      <div class="uk-width-1-1 uk-cover-background header-image" style="background-image:url(' public/uploads/pages/large/{{$pages->fldPagesImage}}')">
        <div class="uk-container uk-container-center">
          <h1>{!! $pages->fldPagesTitle == "" ? $pages->fldPagesName : $pages->fldPagesTitle !!}</h1>
          <h2 class="sub-title">Lorem ipsum set elite dolor</h2>
        </div>
      </div>
