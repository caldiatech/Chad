...
<body>
    ...
    <nav class="d-menu">
        ...
        <ul class="uk-nav uk-nav-offcanvas uk-nav-parent-icon" data-uk-nav="">
            ...
            <li><a href="{{url('/dnradmin/dashboard')}}" data-uk-tooltip="{pos:'right'}" title="Dashboard"><i class="pe-7s-monitor"></i></a></li>
            <li><a href="{{url('/dnradmin/pages')}}" data-uk-tooltip="{pos:'right'}" title="Pages"><i class="pe-7s-photo-gallery"></i></a></li>
            
            <li class="hlbg"><a href="{{url('/dnradmin/manager')}}" data-uk-tooltip="{pos:'right'}" title="Sales Manager"><i class="pe-7s-paper-plane"></i></a></li>

             <li class="hlbg"><a href="{{url('/dnradmin/sales-rep')}}" data-uk-tooltip="{pos:'right'}" title="Sales Rep"><i class="pe-7s-user-female"></i></a></li>

             <li class="hlbg"><a href="{{url('/dnradmin/shop-owner')}}" data-uk-tooltip="{pos:'right'}" title="Shop Owner"><i class="pe-7s-home"></i></a></li>

             <li class="hlbg"><a href="{{url('/dnradmin/client')}}" data-uk-tooltip="{pos:'right'}" title="Client"><i class="pe-7s-users"></i></a></li>

            <li><a href="{{url('/dnradmin/homeslides')}}" data-uk-tooltip="{pos:'right'}" title="Home Slide"><i class="pe-7s-photo"></i></a></li>    
                
                                                
            <? /*<li><a href="{{url('/dnradmin/news')}}" data-uk-tooltip="{pos:'right'}" title="News"><i class="pe-7s-info"></i></a></li>   */ ?>
            <li><a href="{{url('/dnradmin/contact')}}" data-uk-tooltip="{pos:'right'}" title="Contact"><i class="pe-7s-add-user"></i></a></li>                        

            
            <li class="uk-nav-divider"></li>
            <li class="uk-nav-header"><i class="pe-7s-menu" data-uk-tooltip="{pos:'right'}" title="Ecommerce"></i></a></li>
            <li class="hlbg"><a href="{{url('/dnradmin/category')}}" data-uk-tooltip="{pos:'right'}" title="Product"><i class="pe-7s-box2"></i></a></li>
            ...
            <li class="hlbg"><a href="{{url('/dnradmin/orders')}}" data-uk-tooltip="{pos:'right'}" title="Order"><i class="pe-7s-box1"></i></a></li>
            <? /*
            <li class="uk-nav-divider"></li>
            <li class="uk-nav-header"><i class="pe-7s-menu" data-uk-tooltip="{pos:'right'}" title="Video Library"></i></a></li></li>
            <li class="hlbg"><a href="{{url('/dnradmin/teachers')}}" data-uk-tooltip="{pos:'right'}" title="Teachers"><i class="pe-7s-id"></i></a></li>
            <li class="hlbg"><a href="{{url('/dnradmin/students')}}" data-uk-tooltip="{pos:'right'}" title="Students"><i class="pe-7s-study"></i></a></li>
            <li class="hlbg"><a href="{{url('/dnradmin/video-category')}}" data-uk-tooltip="{pos:'right'}" title="Video Category"><i class="pe-7s-video"></i></a></li>
        <li class="hlbg"><a href="{{url('/dnradmin/subscription')}}" data-uk-tooltip="{pos:'right'}" title="Subscription"><i class="pe-7s-star"></i></a></li>
        
<!--            <li><a href="{{url('/dnradmin/logout')}}" data-uk-tooltip="{pos:'right'}" title="Logout"><i class="pe-7s-power"></i></a></li>-->
            */ ?>
        </ul>
...
<footer>
    ...
    <div id="dnr-menu" class="uk-offcanvas">
        ...
        <li class="hlbg"><a href="{{url('/dnradmin/category')}}">Product</a></li>
         ...
         <li class="hlbg"><a href="{{url('/dnradmin/orders')}}" class="fix-lineh">Order</a></li>
         <? /*
                <li class="uk-nav-divider"></li>
                <li class="uk-nav-header">Video Library</li>
        
        <li class="hlbg"><a href="{{url('/dnradmin/students')}}">Students</a></li>
        <li class="hlbg"><a href="{{url('/dnradmin/video-category')}}">Videos</a></li>
        <li class="hlbg"><a href="{{url('/dnradmin/subscription')}}">Subscription</a></li>
        */ ?>
        
        
<!--            <li><a href="{{url('/dnradmin/logout')}}">Logout</a></li>-->
            </ul>
