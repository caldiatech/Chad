                    ...
                    while((list($key,$val)=each($attributes)) && ($val['tag']!='RatedShipment'))
                    {
                        switch($val['tag'])
                        {
                            ...
                            case 'GuaranteedDaysToDelivery':                                
                                $this->ResponseDistilled["RateOption_$ShipRate"]['Days']=isset($val['value']) ? $val['value'] : 0;
                                break;

                            case 'ScheduledDeliveryTime':
                                $this->ResponseDistilled["RateOption_$ShipRate"]['DeliveryTime']=isset($val['value']) ? $val['value'] : 0;
                                break;
