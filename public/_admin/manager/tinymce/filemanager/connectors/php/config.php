...
$fckphp_config['basedir']=$_SERVER['DOCUMENT_ROOT'].'/clarkin123';
//$fckphp_config['basedir'] = 'D:\Work\FCKEditor\www\FCKeditor.V2\editor\filemanager\browser\mcpuk' ;
// $fckphp_config['basedir']="/home3/riderzco/public_html/clarkincollection";
/*==============================================================================*/
...
// $fckphp_config['urlprefix']=$fckphp_config['prot'].$_SERVER['SERVER_NAME'].'/clarkin';
//$fckphp_config['urlprefix']=$fckphp_config['prot'].$_SERVER['SERVER_NAME']."/~site/newadmin";
/*==============================================================================*/
...
/*------------------------------------------------------------------------------*/
$fckphp_config['UserFilesPath'] = "/public/_admin/_filemanager/" ;
/*==============================================================================*/
...
$fckphp_config['ResourceAreas']['File'] =array(
	...
	'AllowedExtensions'	=>	array("zip","rar","doc","txt","xls","pdf","rtf","csv","jpg","gif","jpeg","png","avi","mpg","mpeg","wmv","swf","fla"),
