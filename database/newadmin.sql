...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2015 at 05:39 AM
...
CREATE TABLE IF NOT EXISTS `tbladditionalphotogallery` (
...
CREATE TABLE IF NOT EXISTS `tbladditionalproduct` (
...
CREATE TABLE IF NOT EXISTS `tblauthorize` (
...
(49, NULL, '7', NULL, NULL, NULL, '7-20151214-120', '2015-12-14', 'New', '::1', NULL),
(50, NULL, '7', NULL, NULL, NULL, '7-20151214-297', '2015-12-14', 'New', '::1', NULL);
...
CREATE TABLE IF NOT EXISTS `tblcartcouponcode` (
...
CREATE TABLE IF NOT EXISTS `tblcartshippingrate` (
...
CREATE TABLE IF NOT EXISTS `tblcarttax` (
...
(7, '123', 'Doe', 'test1@dogandrooster.net', 'test1', '$2y$10$ZoiXXQEdTtRsn.0H8PP4Z.jVKhFYCr5fDt26m04XjsULEHfPcyCnK', '327a1d53c95950d3ea9eb7dc99726238440ab19b'),
...
CREATE TABLE IF NOT EXISTS `tblclientsbilling` (
...
(7, '17', 'John', 'Doe', 'Oberlin Drive', '', 'San Diego', 'CA', '92121', 'test1@dogandrooster.net', '855555555', 'US');
...
CREATE TABLE IF NOT EXISTS `tblclientsshipping` (
...
(1, '3', 'John', 'Doe', 'Oberlin Drive', '', 'San Diego', 'CA', '92121', 'test1@dogandrooster.net', '123333', 'US'),
(2, '7', 'John', 'Doe', 'Oberlin Drive', '', 'San Diego', '0', '92121', 'test1@dogandrooster.net', '123', 'US'),
(3, '11', 'steve', 'adams', '1234 main st', 'apt 3', 'san diego', 'CA', '92102', 'steve@dogandrooster.com', '1234567890', 'US'),
(4, '12', 'Angeal', 'Melfi', '888 Happy', '', 'SAN DIEGO', 'CA', '92121', 'angela@dogandrooster.com', '888 888 8888', 'US'),
(5, '14', 'steve1', 'adams', 't', 't', 'test', 'CA', '92102', 'steve1@dogandrooster.com', '1234567890', 'US'),
(6, '16', 'Chris', 'Doe', '456 C Street', NULL, 'San Diego', 'CA', '92024', 'chris@dogandrooster.com', '12334589', 'US'),
...
CREATE TABLE IF NOT EXISTS `tblcountry` (
  `fldCountryID` int(10) unsigned NOT NULL,
  `fldCountryName` varchar(100) NOT NULL DEFAULT '',
  `fldCountryCode` varchar(5) NOT NULL DEFAULT '',
  `fldCountryStatus` enum('enabled','disabled') NOT NULL DEFAULT 'disabled',
  `fldCountryIsDefault` enum('true','false') NOT NULL DEFAULT 'false'
...
INSERT INTO `tblcountry` (`fldCountryID`, `fldCountryName`, `fldCountryCode`, `fldCountryStatus`, `fldCountryIsDefault`) VALUES
...
CREATE TABLE IF NOT EXISTS `tblcouponcode` (
...
CREATE TABLE IF NOT EXISTS `tblfedex` (
...
CREATE TABLE IF NOT EXISTS `tblfooter` (
...
CREATE TABLE IF NOT EXISTS `tblgoogle` (
...
CREATE TABLE IF NOT EXISTS `tblhomeslide` (
...
CREATE TABLE IF NOT EXISTS `tbloptionsassets` (
...
CREATE TABLE IF NOT EXISTS `tblpagespreview` (
...
CREATE TABLE IF NOT EXISTS `tblphotogallery` (
...
CREATE TABLE IF NOT EXISTS `tblproductoptions` (
...
CREATE TABLE IF NOT EXISTS `tbltempcart` (
...
(165, '10', '7', 'Test Shoes', '250', '1', '2015-12-13', ''),
(166, '10', '7', 'Test Shoes', '250', '1', '2015-12-13', ''),
(167, '13', '7', 'Test Shoes 3', '50', '1', '2015-12-13', '');
...
CREATE TABLE IF NOT EXISTS `tblups` (
...
CREATE TABLE IF NOT EXISTS `tblusps` (
...
--
ALTER TABLE `tblcart`
  MODIFY `fldCartID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=51;
--
-- AUTO_INCREMENT for table `tblcartcouponcode`
--
ALTER TABLE `tblcartcouponcode`
  MODIFY `fldCartCouponCodeID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `tblcarttax`
  MODIFY `fldCartTaxID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=39;
--
...
--
ALTER TABLE `tblcountry`
  MODIFY `fldCountryID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=241;
--
...
--
ALTER TABLE `tbltempcart`
  MODIFY `fldTempCartID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=169;
--
